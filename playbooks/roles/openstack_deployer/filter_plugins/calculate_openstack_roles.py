...
class FilterModule(object):
    ...
    def calculate_openstack_roles(self, existing_dict, hostvars):
                ...
                if "hypervisors" in response_dict:
                    for hyp in response_dict["hypervisors"]:
                        if hyp["host_ip"] in self.node_ip_name_map:
                            ...
                            deleted_nodes_list.append(hyp["host_ip"])
                            deleted_nodes_name_list.append(hostname)
                    ...
                    for endpoint_dict in response_dict["endpoints"]:
                        ...
                        if endpoint_port in self.endpoint_port_role_map:
                            ...
                            if endpoint_ip in self.node_ip_name_map:
                                ...
                                deleted_nodes_list.append(endpoint_ip)
                                deleted_nodes_name_list.append(
                                    deleted_server_name)
        ...
        deleted_nodes_list = list(set(deleted_nodes_list))
        deleted_nodes_name_list = list(set(deleted_nodes_name_list))

        return str({"node_roles_dict": instances_nodes_dict,
                    "deleted_nodes_list": deleted_nodes_list,
                    "deleted_nodes_name_list": deleted_nodes_name_list,
