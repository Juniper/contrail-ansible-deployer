...
|             | | +-----------+ | |                  | | +-------+ | |          |
| +---------+ | | +-----------+ | | +--------------+ | | +-------+ | | +------+ |
| |rabbitmq | | | |api        | | | |nodemgr       | | | |control| | | |redis | |+-----------+
| +---------+ | | +-----------+ | | +--------------+ | | +-------+ | | +------+ ||           |
| +---------+ | | +-----------+ | | +--------------+ | | +-------+ | | +------+ || +-------+ |
| |zookeeper| | | |svc monitor| | | |dnsmasq       | | | |dns    | | | |job   | || |nodemgr| |
| +---------+ | | +-----------+ | | +--------------+ | | +-------+ | | +------+ || +-------+ |
| +---------+ | | +-----------+ | | +--------------+ | | +-------+ | | +------+ || +-------+ |
| |cassandra| | | |schema     | | | |device manager| | | |named  | | | |server| || |agent  | |
| +---------+ | | +-----------+ | | +--------------+ | | +-------+ | | +------+ || +-------+ |
|             | |               | |                  | |           | |          ||           |
| configdb    | |  config       | |  device manager  | |  control  | | webui    || vrouter   |
|             | |               | |                  | |           | |          ||           |
+-------------+ +---------------+ +------------------+ +-----------+ +----------++-----------+
```
