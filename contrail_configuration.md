...
# Flags to enable/disable analytics components
# To enable/disable kafka & alarm-gen, set ENABLE_ANALYTICS_ALARM to True
# and to enable snmp and topology, set ENABLE_ANALYTICS_UNDERLAY_OVERLAY to True
ENABLE_ANALYTICS_ALARM=${ENABLE_ANALYTICS_ALARM:-False}
ENABLE_ANALYTICS_UNDERLAY_OVERLAY=${ENABLE_ANALYTICS_UNDERLAY_OVERLAY:-False}
